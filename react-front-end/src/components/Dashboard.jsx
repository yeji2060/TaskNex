...
const Dashboard = ({ userType }) => {
  ...
  const tasks = [
    { id: 1, title: 'Task 1', description: "Description of Task 1", dueDate: '2022-10-20', priority: 'High', status: 'Submitted' },
    { id: 2, title: 'Task 2', description: "Description of Task 2", dueDate: '2024-12-30', priority: 'Low', status: 'Submitted' },
    { id: 3, title: 'Task 3', description: "Description of Task 3", dueDate: '2022-10-14', priority: 'High', status: 'Done' },
    { id: 4, title: 'Task 4', description: "Description of Task 4", dueDate: '2022-10-11', priority: 'High', status: 'Declined' },
    { id: 5, title: 'Task 5', description: "Description of Task 5", dueDate: '2022-10-17', priority: 'Low', status: 'In Progress' }
  ...
  return (
    <Container>
      <Header userType={userType} onCreateTask={handleOpenNewTask} onLogout={handleLogout} />
    ...
    <Grid container spacing={3}>
                ...
                {tasks.filter(task => task.status === status).map((task, index) => (
                  <Grid item xs={12} key={index}>
                    <Card onClick={() => handleOpenTask(task)} sx={{ mb: 2 }}>
                      <CardContent>
                        <TaskCards title={task.title} description={task.description} dueDate={task.dueDate} priority={task.priority} />
                      </CardContent>
                    </Card>
                  </Grid>
                ))}
      ...
      <NewTaskModule task={{}} open={isTaskModuleOpen} onClose={handleCloseNewTask} />
